...
\begin{enumerate}
  ...
  \item \textbf{Uniformiser les documents} internes et externes via un \textbf{référentiel de 25 templates LaTeX versionnés}, couvrant les 5 phases PMBOK et applicables à tous les projets du portefeuille --- Ch.\ 3.
...
\section{Catalogue des 25 templates --- chemins et fréquence}
...
\midrule
P4-15 & Tableau de bord projet     & Mensuel & \pth{P4-15\_tableau\_de\_bord\_projet.tex}  & \pth{P4-15\_tableau\_de\_bord\_projet.pdf} \\
\rowcolor{cnIce}
P4-16 & Rapport d'écarts           & En cas d'écart & \pth{P4-16\_rapport\_ecarts.tex}     & \pth{P4-16\_rapport\_ecarts.pdf} \\
P4-17 & Slides COPIL               & Mensuel & \pth{P4-17\_slides\_copil.tex}              & \pth{P4-17\_slides\_copil.pdf} \\
\midrule

\multicolumn{5}{l}{\cellcolor{cnNavy!15}\textbf{\textcolor{cnNavy}{Phase 5 --- Clôture}}} \\
\midrule
\rowcolor{cnIce}
P5-18 & PV de recette fonctionnelle & Une fois & \pth{P5-18\_pv\_recette\_fonctionnelle.tex} & \pth{P5-18\_pv\_recette\_fonctionnelle.pdf} \\
P5-19 & PV de recette technique    & Une fois & \pth{P5-19\_pv\_recette\_technique.tex}     & \pth{P5-19\_pv\_recette\_technique.pdf} \\
\rowcolor{cnIce}
P5-20 & PV transfert exploitation  & Une fois & \pth{P5-20\_pv\_transfert\_exploitation.tex} & \pth{P5-20\_pv\_transfert\_exploitation.pdf} \\
P5-21 & Lettre fin mission ESN     & Une fois & \pth{P5-21\_lettre\_fin\_mission\_esn.tex}  & \pth{P5-21\_lettre\_fin\_mission\_esn.pdf} \\
\rowcolor{cnIce}
P5-22 & Bilan de clôture           & Une fois & \pth{P5-22\_bilan\_cloture.tex}             & \pth{P5-22\_bilan\_cloture.pdf} \\
P5-23 & Fiche REX                  & Une fois & \pth{P5-23\_fiche\_rex.tex}                 & \pth{P5-23\_fiche\_rex.pdf} \\
\end{longtable}

\begin{reco}
Le \textbf{dossier compagnon PMP Refonte Web} (cf.\ Ch.\ 7) démontre l'instanciation de \textbf{13 de ces 23 templates} sur le projet Refonte Web. Les 10 templates restants (P3-14, P4-15--17, P5-18--23) seront instanciés au fil de l'avancement du projet.
\end{reco}
...
\begin{finding}
Le pilotage opérationnel de la Refonte Web s'appuie sur un \textbf{dossier compagnon} (\texttt{pmp\_refonte\_web.pdf}) qui rassemble les \textbf{13 documents instanciés} à partir des templates du référentiel (Ch.\ 3). Chaque document est compilé en PDF autonome dans \texttt{projets/refonte\_web/pdf/}. Le présent chapitre fait office d'\textbf{index navigationnel}.
\end{finding}

\section{Architecture du dossier compagnon}

\begin{itemize}
  \item \textbf{Document maître} : \texttt{pmp\_refonte\_web.pdf} --- index, carte d'identité, table des 13 documents, engagements contractuels.
  ...
  \item \textbf{12 documents annexes} --- charte, RACI, note de cadrage, WBS, Gantt, budget, risques, communication, conduite du changement, fiche d'identification, CR de réunion (kick-off), rapport d'avancement (M+1).
\end{itemize}

\section{Index des 13 documents instanciés}
...
\begin{finding}
Au-delà des 13 documents déjà instanciés, le pilotage Phase 3--5 génère les livrables suivants à produire au fil de l'eau à partir des templates du référentiel.
\end{finding}
...
\rowcolor{cnIce}
P4-15         & Tableau de bord projet       & Mensuel             & Mai 2026 (intégré cockpit) \\
P4-16         & Rapport d'écarts             & Sur seuil dépassé   & Si IPC ou IPD $<$ 0{,}90 \\
\rowcolor{cnIce}
P4-17         & Slides COPIL                 & Mensuel             & COPIL inception 20/05/2026 \\
P5-18         & PV de recette fonctionnelle  & 1 fois              & 31/08/2026 (J4) \\
\rowcolor{cnIce}
P5-19         & PV de recette technique      & 1 fois              & 31/08/2026 (J4) \\
P5-20         & PV transfert exploitation    & 1 fois              & 30/09/2026 (J5) \\
\rowcolor{cnIce}
P5-22         & Bilan de clôture             & 1 fois              & 30/09/2026 (J5) \\
...
% ============================================================
% ANNEXE — CHECKLIST DE LA GRILLE D'ÉVALUATION
% ============================================================
...
\begin{center}
\renewcommand{\arraystretch}{1.6}
\begin{tabularx}{\textwidth}{C{0.5cm} L{6.5cm} C{2cm} C{1.8cm} C{3.5cm}}
\toprule
\rowcolor{cnNavy}
...
\midrule
1 & Processus de management basé sur standards & 2 pts & \cellcolor{cnGreen!25}Oui & Partie I --- Ch.\ 2 \\
\rowcolor{cnIce}
2 & Plan du référentiel documentaire (avec chemins) & 3 pts & \cellcolor{cnGreen!25}Oui & Partie I --- Ch.\ 3 \\
3 & Template tableau de bord supervision & 3 pts & \cellcolor{cnGreen!25}Oui & Partie I --- Ch.\ 4 \\
\midrule
\multicolumn{5}{l}{\cellcolor{cnNavy!15}\textbf{\textcolor{cnNavy}{Axe 2 --- Superviser et conduire les projets IT (5 pts)}}} \\
\midrule
\rowcolor{cnIce}
4 & Plan de management complet (Refonte Web) & 3 pts & \cellcolor{cnGreen!25}Oui & Partie II --- Ch.\ 5 + \texttt{pmp\_refonte\_web.pdf} + P2-05 instancié \\
5 & Tableau de bord de suivi projet & 2 pts & \cellcolor{cnGreen!25}Oui & Partie II --- Ch.\ 6 + P3-13 instancié \\
\midrule
\multicolumn{5}{l}{\cellcolor{cnNavy!15}\textbf{\textcolor{cnNavy}{Axe 3 --- Clore les projets et capitaliser (5 pts)}}} \\
\midrule
\rowcolor{cnIce}
6 & Documents contractuels de clôture (référentiel) & 2 pts & \cellcolor{cnGreen!25}Oui & Ch.\ 3 (P5-18 à P5-23) \\
7 & Processus d'amélioration continue + PDCA & 3 pts & \cellcolor{cnGreen!25}Oui & Partie I --- Ch.\ 4 §4.4 \\
\midrule
\multicolumn{5}{l}{\cellcolor{cnNavy!15}\textbf{\textcolor{cnNavy}{Axe 4 --- Application au projet (Partie II --- bonus contextuel)}}} \\
\midrule
8 & WBS graphique (PNG PlantUML) & --- & \cellcolor{cnGreen!25}Oui & Ch.\ 6 §6.3 + \texttt{wbs\_refonte\_web.png} \\
\rowcolor{cnIce}
9 & Dossier PMP compagnon (13 PDFs) & --- & \cellcolor{cnGreen!25}Oui & Ch.\ 7 + \texttt{pmp\_refonte\_web.pdf} \\
\midrule
\rowcolor{cnNavy!15}
